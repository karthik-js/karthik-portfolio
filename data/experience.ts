...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      "Established track ownership boundaries that enabled two parallel tracks to ship independently with zero cross-track regressions — cutting average PR-to-merge cycle time and eliminating integration bottlenecks",
      ...
      "Instrumented frontend observability and unified analytics tracking through a typed event schema; codified engineering standards for branching, security, accessibility, and performance adopted across the project",
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Shipped a full-suite POSH compliance platform (Conduct) in 4 months for organizations with 1000+ employees — covering registration, complaint tracking, video-based learning, and interactive assessments",
      "Built complaint management dashboards and learning module interfaces; designed admin tooling for company-wide POSH initiatives — course assignment, progress tracking, and compliance reporting",
    ],
  },
  {
    role: "MERN Developer",
    ...
    industry: "Enterprise Compliance SaaS",
    earlyCareer: true,
    bullets: [
      "Contributed to migrating a legacy PHP codebase to React, modernizing the frontend architecture and improving overall accessibility",
      "Customized Google Time Picker to match specific business requirements, boosting user satisfaction scores by 25% within two months of launch",
      "Improved UI/UX and accessibility practices across the platform, achieving a 25% uplift in Lighthouse accessibility scores",
      "Established a code quality pipeline enforcing standards across the team, reducing code review time by 20%",
    ],
  },
  {
